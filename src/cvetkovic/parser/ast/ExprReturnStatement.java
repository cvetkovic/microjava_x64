...
public class ExprReturnStatement extends ReturnStatement {

    private MakeNewExpressionDAG MakeNewExpressionDAG;
    private Expr Expr;

    public ExprReturnStatement(MakeNewExpressionDAG MakeNewExpressionDAG, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExprReturnStatement(\n");
